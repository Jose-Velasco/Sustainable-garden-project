...
@Component({
    selector: "ns-dashboard-overview", //where in nativescript is this component
    templateUrl: "./dashboard-overview.component.html", // which html doc is this associated to
    styleUrls: ["./dashboard-overview.component.scss"] // which scss styling doc is this associated to
})
...
export class DashboardOverviewComponent implements OnInit, OnDestroy {
    ...
    //! could be removed if we change the card to be used with data than a button?
    onSunlightTest(): void {
